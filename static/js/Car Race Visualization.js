    ...
    { 
      ...
      title: { 
        ...
        label: { 
          margin_bottom: 40, 
          text: 
            'US Total Number of Employees by State, Thousands of Persons'
        } 
      }, 
      annotations: [ 
        { 
      ...
      legend: { 
        ...
        customEntries: [ 
          { 
            name: 'Northeast', 
            icon: { 
              color: regionColors['Northeast'] 
            } 
          }, 
          { 
            name: 'Midwest', 
            icon: { 
              color: regionColors['Midwest'] 
            } 
          }, 
          { 
            name: 'South', 
            icon: { color: regionColors['South'] } 
          }, 
          { 
            name: 'West', 
            icon: { color: regionColors['West'] } 
          } 
        ] 
      }, 
